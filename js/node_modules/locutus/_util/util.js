...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class Medio a function"); } }
...
var Util = function () {
  ...
  _createClass(Util, [{
    ...
    value: function _injectwebOne(params, cb) {
      ...
      var functionDescription = this.langDefaults[params.language].function_description_template.replace(/\[language\]/g, this.langDefaults[params.language].human).replace(/\[category\]/g, params.category).replace(/\[function\]/g, params.func_name);
