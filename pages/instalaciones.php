						...
						<div class="gallery">
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion01.jpg" alt="">
									<div class="gallery-hover">
										<h4>Entrada principal al Colegio Militar</h4>
							...
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion02.jpg" alt="">
									<div class="gallery-hover">
										<h4>Patio de Armas</h4>
										<!--<span>Coorporate Law</span>-->
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion03.jpg" alt="">
									<div class="gallery-hover">
										<h4>Jardines frente a la Dirección</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion04.jpg" alt="">
									<div class="gallery-hover">
										<h4>Pabellón de comedor y casino de cadetes</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion05.jpg" alt="">
									<div class="gallery-hover">
										<h4>Cuadra de varones 5to año y personal militar</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion06.jpg" alt="">
									<div class="gallery-hover">
										<h4>Cuadra de cadetes femeninas</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion07.jpg" alt="">
									<div class="gallery-hover">
										<h4>Aulas</h4>
									</div>
								</div><!-- Gallery Image -->
							...
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion08.jpg" alt="">
									<div class="gallery-hover">
										<h4>Laboratorios de Informática</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion09.jpg" alt="">
									<div class="gallery-hover">
										<h4>Modernos Laboratorios de Química y Biología</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion10.jpg" alt="">
									<div class="gallery-hover">
										<h4>Sala de Banderas</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion11.jpg" alt="">
									<div class="gallery-hover">
										<h4>Piscina</h4>
									</div>
								</div><!-- Gallery Image -->
							...
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion12.jpg" alt="">
									<div class="gallery-hover">
										<h4>Gimnasio</h4>
									</div>
								</div><!-- Gallery Image -->
							...
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion13.jpg" alt="">
									<div class="gallery-hover">
										<h4>Capilla del Colegio Militar</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion14.jpg" alt="">
									<div class="gallery-hover">
										<h4>Campos deportivos</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
							<div class="col-md-4">
								<div class="gallery-img">
									<img src="../images/instalacion15.jpg" alt="">
									<div class="gallery-hover">
										<h4>Museo de Ramón Castilla</h4>
									</div>
								</div><!-- Gallery Image -->
							</div>
						</div>
