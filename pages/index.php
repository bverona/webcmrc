			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="practice-area-carousel">
						<div class="practice">
							<div class="practice-img"><img src="../images/service01.jpg" alt="" /></div>
							<div class="practice-detail">
								<!--<img src="images/practice1.png" alt="" />
								<i>01</i>-->
								<span style="font-size: 16px; font-weight: bold;">Formación Académica</span>
								<!--<h3><a href="#" title="">CRIMINAL LAW</a></h3>-->
								<p style="font-size: 12px; line-height: 19px; text-align: justify;">Para alcanzar tales objetivos, el Colegio cuenta con una selecta y experimentada plana docente, que desarrolla sus labores académicas de acuerdo a los planes oficiales de estudios, las normas y las directivas impartidos por el Ministerio de Educación.</p>
							</div>
						</div><!-- Practice -->

						<div class="practice">
							<div class="practice-img"><img src="../images/service02.jpg" alt="" /></div>
							<div class="practice-detail">
								<!--<img src="images/practice2.png" alt="" />
								<i>02</i>-->
								<span style="font-size: 16px; font-weight: bold;">Formación Militar</span>
								<!--<h3><a href="#" title="">DIVORCE LAW</a></h3>-->
								<p style="font-size: 12px; line-height: 19px; text-align: justify;">Formar en el personal de cadetes hábitos de orden, respeto, obediencia y sobre todo, amor a la verdad y al cumplimiento del deber. Desarrollar la cultura física, impartida y orientada hacia la conservación de la salud y la preparación para las prácticas atléticas y deportivas.</p>
							</div>
						</div><!-- Practice -->

						<div class="practice">
							<div class="practice-img"><img src="../images/service03.jpg" alt="" /></div>
							<div class="practice-detail">
								<!--<img src="images/practice3.png" alt="" />
								<i>03</i>-->
								<span style="font-size: 15px; font-weight: bold;">Departamento Psicológico</span>
								<!--<h3><a href="#" title="">INSURANCE LAW</a></h3>-->
								<p style="font-size: 12px; line-height: 19px; text-align: justify;">Aplicar y evaluar la prueba del concurso de admisión a los postulantes. Velar por la exactitud y oportunidad en el registro, elaboración e interpretación de los datos relativos a la personalidad de los cadetes. Promover actividades de orientación vocacional y profesional.</p>
							</div>
						</div><!-- Practice -->

						<div class="practice">
							<div class="practice-img"><img src="../images/service04.jpg" alt="" /></div>
							<div class="practice-detail">
								<!--<img src="images/practice3.png" alt="" />
								<i>04</i>-->
								<span style="font-size: 15px; font-weight: bold;">Atención Médica y Dental</span>
								<!--<h3><a href="#" title="">INSURANCE LAW</a></h3>-->
								<p style="font-size: 12px; line-height: 19px; text-align: justify;">Atención médica y dental para nuestros cadetes, la salud es primordial para el buen desempeño, es por eso que nuestras áreas están especializadas para brindarles un servicio de calidad.</p>
							</div>
						</div><!-- Practice -->
