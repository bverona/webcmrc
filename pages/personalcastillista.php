...
<header>
	...
	<div class="container" style="margin-top: 10%; margin-bottom: 5%;">
		<div class="title">
				...
				<h2>PERSONAL CASTILLISTA 2016</h2>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-bordered">
						<thead>
							<tr>
								<th colspan="5">Personal Administrativo Nombrado y Contratado de la IEPM "GMRC"</th>
							</tr>
							<tr>
								<th>N°</th>
								<th>Apellidos y Nombres</th>
								<th>Cargo según  Resol. NOM y/o CONT.</th>
								<th>DNI</th>
						...
						<tbody>
							<tr>
								<td>01</td>
								<td>ABANTO CERNA, AMELIA AURORA</td>
								<td>TRAB. SERV. III</td>
								<td>42405176</td>
								<td>amelia172@hotmail.com</td>
							</tr>
							<tr>
								<td>02</td>
								<td>AKARLEY LOAYZA, ALEX A.</td>
								<td>TRAB. SERV. II</td>
								<td>18102333</td>
								<td></td>
							</tr>
							<tr>
								<td>03</td>
								<td>AKARLEY VIDAL, CARLA</td>
								<td>SECRETARIA I</td>
								<td>18204389</td>
								<td>carfer1702@hotmail.com</td>
							</tr>
							<tr>
								<td>04</td>
								<td>ALAYO SOBRADO, ASIS ARMANDO</td>
								<td>AUX. DE BIBLIOTECA I</td>
								<td>18076752</td>
								<td></td>
							</tr>
							<tr>
