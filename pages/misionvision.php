					...
					<div class="practice-area-carousel">
						<div class="practice">
							...
							<div class="practice-detail" style="opacity: 0.8">
								...
								<i>01</i>-->
								<span style="font-size: 20px; font-weight: bold;">Misión</span>
								<!--<h3><a href="#" title="">CRIMINAL LAW</a></h3>-->
								<p style="font-size: 12px; line-height: 19px; text-align: justify; color: #1d1d1d;">Establecer una educación científico-humanístico de calidad en la Institucion Educativa Pública Militar "Gran Mariscal Ramón Castilla" a través del desarrollo de la ciencia, la tecnología y el deporte, promoviendo condiciones para el desarrollo individual y social de nuestros cadetes en una búsqueda permanente de la excelencia educativa.</p>
							</div>
						</div><!-- Practice -->

						<div class="practice">
							<div class="practice-img"><img src="../images/mision01.jpg" alt="" /></div>
							<div class="practice-detail" style="opacity: 0.8">
								<!--<img src="images/practice2.png" alt="" />
								<i>02</i>-->
								<span style="font-size: 20px; font-weight: bold;">Visión</span>
								<!--<h3><a href="#" title="">DIVORCE LAW</a></h3>-->
								<p style="font-size: 12px; line-height: 19px; text-align: justify; color: #1d1d1d;">Ser una Institucion Educativa líder en formar hombres y mujeres de bien, con una sólida formación integral, fortalecidos en una cultura de valores, jovenes proactivos con cualidades y virtudes morales para ser útiles a la sociedad y a la Patria".</p>
							</div>
						</div><!-- Practice -->
