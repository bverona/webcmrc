				...
				<div class="col-md-12">
					<div class="blog-detail">
						<div class="detail-img">
							<img src="../images/noticeext05.jpg" alt="" />
							<div class="blog-author"><img src="http://placehold.it/52x52" alt="" /></div>
						</div>
						<div class="blog-detail-desc">
							<div class="blog-date">24 <span>Enero</span></div>
							<div class="blog-text">
								<h2 class="blog-title">Inauguración Olimpiadas de Ex Cadetes Verano 2016</h2>
								<p style="text-align: justify; font-size: 16px;">Con la concurrida presencia de las diferentes promociones de Ex Cadetes del Colegio Militar, se llevó a cabo el día domingo 24 de Enero la Gran Inauguración de las Olimpiadas de Verano - 2016 de Ex Cadetes Castillistas organizado por la XXVI PROMOCION "TARAPACÁ" 1989 - 1991 que estuvo amenizado por la Orquesta "Los Caribeños de Guadalupe, donde se presenciaron diferentes espectáculos con la exhibición de caballos de paso y la Policía Canina.<br> Felicitamos a la Promoción "Tarapacá" por la excelente organización.</p>
							</div>
