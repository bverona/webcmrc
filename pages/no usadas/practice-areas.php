						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="practice">
									...
									<div class="practice-detail">
										...
										<i>04</i>
										<span>Many Years Of Exp</span>
										<h3><a href="#" title="">COORPORATE LAW</a></h3>
										<p>Vestibulum at magna tellus. Vivamus sagittis et nunc aliquet. Vivamin orce aliquam, aco vulputate leo vehiculag auris porttitor eros vel.</p>
									</div>
								</div><!-- Practice -->
							</div>
							<div class="col-md-6">
								<div class="practice">
									...
									<div class="practice-detail">
										...
										<i>05</i>
										<span>Many Years Of Exp</span>
										<h3><a href="#" title="">FINANCIAL LAW</a></h3>
										<p>Vestibulum at magna tellus. Vivamus sagittis et nunc aliquet. Vivamin orce aliquam, aco vulputate leo vehiculag auris porttitor eros vel.</p>
									</div>
								</div><!-- Practice -->
							</div>
							<div class="col-md-6">
								<div class="practice">
									<div class="practice-img"><img src="http://placehold.it/470x423" alt="" /></div>
									<div class="practice-detail">
										<img src="../../images/practice6.png" alt="" />
										<i>06</i>
										<span>Many Years Of Exp</span>
										<h3><a href="#" title="">ACCIDENTAL LAW</a></h3>
										<p>Vestibulum at magna tellus. Vivamus sagittis et nunc aliquet. Vivamin orce aliquam, aco vulputate leo vehiculag auris porttitor eros vel.</p>
									</div>
								</div><!-- Practice -->								
							</div>
