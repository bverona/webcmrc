    <div class="">
        <div class="container">
            ...
            <nav>
                <ul>
                    <li>
                        <a data-letter="Inicio" href="index.php" title="Inicio" style="color: #080808;font-weight: bold;font-size: 14px;">Inicio</a>
                        <a data-letter="Administrar" href="index.php" title="Inicio" style="color: #080808;font-weight: bold;font-size: 14px;">administrar<i class="fa fa-desktop"></i> </a>
                        <a data-letter="Inicio" href="index.php" title="Inicio" style="color: #080808;font-weight: bold;font-size: 14px;">Inicio</a>
                        <a data-letter="Inicio" href="index.php" title="Inicio" style="color: #558b2f;font-weight: bold;font-size: 14px;">Inicio</a>
                        <a class="" href="Administrar" target="" title="#"><i class="fa fa-desktop"></i> Registra Noticia</a>
                        <!-- Menu Bar
                            <a class="" href="Administrar" target="" title="#"><i class="fa fa-desktop"></i> Registra Noticia</a>
